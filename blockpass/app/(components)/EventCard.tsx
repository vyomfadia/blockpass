...
export default function EventCard({
  ...
  return (
    <div
      ...
      className={` ${className} w-[280px] snap-start hover:bg-[#fff1] h-[500px] overflow-hidden relative hover:backdrop-blur-[5px] drop-shadow-none hover:to-[100%] group cursor-pointer duration-300 `}
    >
